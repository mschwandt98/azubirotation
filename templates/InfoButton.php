<div id="InfoButton">
    <div style="display: none;">
        ...
        <div>
            Um Termine wie beispielsweise "Zeugnisse" einzutragen, das entsprechende Feld per Rechtsklick auswählen, im
            aufkommenden Popup "Termin setzen" anklicken und die Terminbezeichnung in das Feld eintragen. Den Termin mit
            Klick auf den Button "Termin setzen" bestätigen.
        </div>
        <div>
            Um einen Termin umzubenennen oder zu löschen auf das entsprechende Feld mit der rechten Maustaste klicken
            und die gewünschte Aktion auswählen. Beim Klick auf "Termin umbennenen" wie beim Hinzufügen eines Termins
            fortfahren. Mit Klick auf "Termin löschen" wird der Termin entfernt.
        </div>
        <div>
